...
<head>
    ...
    <meta name="description" content="{{ trans('message.appname') }} ">
    <meta name="author" content="Kacper Grabowski">

    <meta property="og:title" content="Adminlte-laravel" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="{{ trans('message.appname') }}" />
